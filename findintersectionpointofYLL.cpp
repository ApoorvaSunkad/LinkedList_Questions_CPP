...
//Brute force
//T.C = O(N1*N2)
//S.C = O(N1) or O(N2) depending on which LL you are storing in map
...
//Please please watch striver's video for this question
//He has explained very nicely

//Video link: striver's Linked list playlist