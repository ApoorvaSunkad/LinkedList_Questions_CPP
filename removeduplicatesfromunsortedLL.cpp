...
the node which appeared first should be kept, all others duplicates are to be 
removed.
...
the head of the linked list.  Your function should return a pointer to a linked 
list with no duplicate element.
